...
async def create_users(count: int):
    for i in range(count):
        query = db.users.insert().values(name=f'user{i}', surname=f'surname{i}',
...
async def update_product(product_id: int, new_product: schemas.ProductCreate):
...
async def update_order(order_id: int, new_order: schemas.OrderCreate):
